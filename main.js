const translations = {
  ko: {
    ...
    "form-message": "문의 내용",
    "btn-submit": "문의 보내기",
    "comments-title": "사용자 의견 및 커뮤니티",
    "comments-subtitle": "분석 도구 사용 후기나 개선 아이디어를 자유롭게 남겨주세요.",
    "footer-copy": "© 2026 Ladder Analyst. Multi-modal Gemini 최적화.",
    "footer-privacy": "개인정보처리방침",
    "footer-contact": "문의하기",
    "support-brands": "주요 지원 PLC 브랜드",
    "kb1-title": "PLC AI 분석이 필요한 이유",
    "kb1-desc": "현대 산업 자동화 시스템은 수천 라인의 래더 로직으로 구성됩니다. 단순한 타이머 하나를 수정하려 해도 전체 인터록(Interlock) 관계를 파악해야 합니다.",
    "kb1-li1": "복잡한 시퀀스 제어 흐름의 빠른 요약",
    "kb1-li2": "타 엔지니어가 작성한 로직의 즉각적인 해독",
    "kb1-li3": "잠재적인 논리 오류 및 중복 코일 감지",
    "kb2-title": "멀티모달 AI 활용 팁",
    "kb2-desc": "단순히 이미지만 올리는 것보다, PLC 브랜드와 분석 목적을 명확히 하면 훨씬 정확한 결과를 얻을 수 있습니다.",
    "kb2-tip": "TIP: 전체 화면보다는 분석이 필요한 특정 루틴(Routine)이나 펑션 블록(FB) 단위를 캡처하세요.",
    "kb3-title": "전문가용 프롬프트",
    "kb3-desc": "엔지니어의 의도를 AI에게 정확히 전달하기 위해 설계된 특수 프롬프트 구조를 제공합니다.",
    "kb3-tag1": "스캔 타임 최적화",
    "kb3-tag2": "인터록 검증",
    "faq-title": "자주 묻는 질문 (FAQ)",
    "faq1-q": "Q. PLC 래더 로직이란 무엇인가요?",
    "faq1-a": "PLC(Programmable Logic Controller) 래더 로직(Ladder Logic)은 산업 자동화 분야에서 가장 널리 사용되는 프로그래밍 언어입니다. 전기 회로도와 유사한 '사다리' 형태의 그래픽 기반 언어로, 릴레이(Relay) 제어 회로를 직관적으로 표현하여 엔지니어들이 쉽게 이해하고 유지보수할 수 있도록 설계되었습니다.",
    "faq2-q": "Q. 왜 AI를 이용해 분석해야 하나요?",
    "faq2-a": "수천 라인에 달하는 복잡한 PLC 프로그램을 사람이 일일이 분석하는 것은 많은 시간과 노력이 소요됩니다. Google Gemini와 같은 최신 멀티모달 AI는 이미지 속의 접점(Contact)과 코일(Coil) 관계를 시각적으로 인식하고, 전체적인 제어 흐름을 빠르게 요약하거나 잠재적인 오류를 찾아낼 수 있습니다.",
    "faq3-q": "Q. 보안상 안전한가요?",
    "faq3-a": "네, 안전합니다. 본 사이트는 서버에 사용자의 파일을 업로드하거나 저장하지 않습니다. 모든 파일 처리는 사용자의 브라우저 내에서만 이루어지며, 생성된 프롬프트 텍스트만 Google Gemini 등으로 복사하여 사용할 수 있습니다.",
    "faq4-q": "Q. 지원하는 파일 형식은 무엇인가요?",
    "faq4-a": "이미지(PNG, JPG), PDF 문서를 지원합니다. 또한 텍스트 기반 소스인 .L5X(Rockwell), .xgm(LS ELECTRIC), .txt 등도 분석 프롬프트에 포함할 수 있습니다.",
    // Prompt translations
  ...
  en: {
    ...
    "comments-title": "Community & Feedback",
    "comments-subtitle": "Feel free to leave reviews or improvement ideas for the analysis tool.",
  ...
  vi: {
    ...
    "comments-title": "Ý kiến người dùng & Cộng đồng",
    "comments-subtitle": "Hãy thoải mái để lại đánh giá hoặc ý tưởng cải tiến cho công cụ phân tích.",
  ...
  es: {
    ...
    "comments-title": "Opiniones y Comunidad",
    "comments-subtitle": "Siéntase libre de dejar sus opiniones o ideas de mejora para la herramienta de análisis.",
    "footer-copy": "© 2026 Ladder Analyst.",
  ...
  de: {
    ...
    "comments-title": "Community & Feedback",
    "comments-subtitle": "Hinterlassen Sie gerne Feedback oder Verbesserungsvorschläge für das Analysetool.",
    "footer-copy": "© 2026 Ladder Analyst.",
  ...
  fr: {
    ...
    "comments-title": "Avis des utilisateurs & Communauté",
    "comments-subtitle": "N'hésitez pas à laisser vos avis ou des idées d'amélioration pour l'outil d'analyse.",
    "footer-copy": "© 2026 Ladder Analyst.",
  ...
  hi: {
    ...
    "comments-title": "उपयोगकर्ता प्रतिक्रिया और समुदाय",
    "comments-subtitle": "एनालिसिस टूल के लिए अपनी समीक्षाएं या सुधार के विचार साझा करें।",
    "footer-copy": "© 2026 Ladder Analyst.",
